...
const teams = [
  { id: 1, name: 'Sales', href: '#', initial: 'S', current: false },
  { id: 2, name: 'Marketing', href: '#', initial: 'M', current: false },
  { id: 3, name: 'Human Resources', href: '#', initial: 'H', current: false },
];
          ...
          <div className="flex grow flex-col gap-y-5 overflow-y-auto bg-gray-900 px-6 pb-4">
            <div className="flex h-16 shrink-0 items-center gap-3">
              ...
              <SwatchIcon
                ...
                aria-hidden="true"
              />
              <p className="text-white font-bold"> FlowFusion Corp</p>
            </div>
            <nav className="flex flex-1 flex-col">
              <ul role="list" className="flex flex-1 flex-col gap-y-7">
                <li>
            ...
            <div className="flex flex-1 gap-x-4 self-stretch lg:gap-x-6">
              <form className="relative flex flex-1" action="#" method="GET">
                <div className="grow flex items-center justify-between gap-5  ">
                  ...
                  <MagnifyingGlassIcon
                    className=" hidden sm:block pointer-events-none absolute inset-y-0 left-2 h-full w-5 text-gray-400"
                    aria-hidden="true"
                  />
                  <input
                    id="search-field"
